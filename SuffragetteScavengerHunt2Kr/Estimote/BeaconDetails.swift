...
class BeaconDetails {
    ...
    let beaconPublicID: String
    let suffragetteName: String
    let suffragetteDesc: String
    let suffragetteImg: String

    init(beaconName: String, backgroundColor: UIColor, beaconPublicID: String) {
        self.beaconName = beaconName
        self.backgroundColor = backgroundColor
        self.beaconPublicID = beaconPublicID
        self.suffragetteName = SuffragetteDetails.instance.suffragetteInfo[beaconPublicID]!["name"]!
        self.suffragetteDesc = SuffragetteDetails.instance.suffragetteInfo[beaconPublicID]!["description"]!
        self.suffragetteImg = SuffragetteDetails.instance.suffragetteInfo[beaconPublicID]!["image"]!
    }

    convenience init(beaconName: String, beaconColor: ESTColor, beaconPublicID: String) {
        self.init(
            beaconName: beaconName,
            backgroundColor: BeaconDetails.backgroundColor(for: beaconColor),
            beaconPublicID: beaconPublicID)
    }
